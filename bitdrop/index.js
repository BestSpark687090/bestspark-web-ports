...
// include: C:\Users\andre\AppData\Local\Temp\tmpilih5mri.js
...
(() => {
  ...
  loadPackage({
    "files": [ {
      ...
      "filename": "/assets/sfx/cashout.wav",
      "start": 34434219,
      "end": 34443461
    }, {
      ...
      "filename": "/assets/sfx/overload.wav",
      "start": 34954933,
      "end": 35896223
    }, {
      "filename": "/assets/sfx/score.wav",
      "start": 35896223,
      "end": 35926343
    }, {
    ...
    "remote_package_size": 36066403
  });
})();

// end include: C:\Users\andre\AppData\Local\Temp\tmpilih5mri.js
// include: C:\Users\andre\AppData\Local\Temp\tmp7c6rsrug.js
...
// end include: C:\Users\andre\AppData\Local\Temp\tmp7c6rsrug.js
// include: C:\Users\andre\AppData\Local\Temp\tmpe1f1xgmk.js
...
// end include: C:\Users\andre\AppData\Local\Temp\tmpe1f1xgmk.js
var programArgs = [];
...
var ASM_CONSTS = {
  ...
  157978: () => document.getElementById("canvas").width,
  158030: () => parseInt(document.getElementById("canvas").style.width),
  158098: () => {
  ...
  158244: () => document.getElementById("canvas").width,
  158296: () => screen.width,
  158321: () => {
    document.exitFullscreen();
  },
  ...
  158481: () => window.innerWidth,
  158507: () => window.innerHeight,
  158534: () => {
    if (document.fullscreenElement) return 1;
  },
  158580: () => document.getElementById("canvas").width,
  158632: () => parseInt(document.getElementById("canvas").style.width),
  158700: () => {
    if (document.fullscreenElement) return 1;
  },
  158746: () => document.getElementById("canvas").width,
  158798: () => screen.width,
  158823: () => window.innerWidth,
  158849: () => window.innerHeight,
  158876: () => {
    if (document.fullscreenElement) return 1;
  },
  158922: () => document.getElementById("canvas").width,
  158974: () => screen.width,
  158999: () => {
    document.exitFullscreen();
  },
  ...
  159072: () => document.getElementById("canvas").width,
  159124: () => parseInt(document.getElementById("canvas").style.width),
  159192: () => {
    document.exitFullscreen();
  },
  159219: $0 => {
  ...
  159277: () => screen.width,
  159302: () => screen.height,
  159328: () => window.screenX,
  159355: () => window.screenY,
  159382: $0 => {
  ...
  159936: () => window.innerWidth,
  159962: () => window.innerHeight,
  159989: () => {
  ...
  162358: () => (navigator.mediaDevices !== undefined && navigator.mediaDevices.getUserMedia !== undefined),
  162462: () => {
    try {
  ...
  165461: $0 => miniaudio.get_device_by_index($0).webaudio.sampleRate,
  165527: $0 => {
